...
export class UpdateWantedCriminalDto {
    @ApiPropertyOptional({ description: 'Full name of the wanted person', example: 'Nguyen Van A' })
    @IsString()
    @IsOptional()
    ...
    @ApiPropertyOptional({ description: 'Crime description (Tội danh)', example: 'Trom cap tai san' })
    @IsString()
    @IsOptional()
